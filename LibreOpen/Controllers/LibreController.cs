...
namespace LibreOpen.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class LibreController : ControllerBase
    {

        private readonly StudentDataContext _studentDataContext;

        public LibreController(StudentDataContext studentDataContext)
        {
        ...
        // POST api/<LibreController>
        [HttpPost]
        public void Post([FromBody] string value)
        {
        }

        // PUT api/<LibreController>/5
        [HttpPut("{id}")]
        public void Put(int id, [FromBody] string value)
        {
        }

        // DELETE api/<LibreController>/5
        [HttpDelete("{id}")]
